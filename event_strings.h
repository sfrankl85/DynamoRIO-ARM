...
#define MSG_CLIENT_EXCEPTION_STRING "Application %s (%s).  Client exception at PC %s.  Program aborted. %s"
...
#define MSG_WIN8_PRIVATE_KERNELBASE_NYI_STRING "Application %s (%s). Private kernelbase.dll not fully supported on Windows 8."
